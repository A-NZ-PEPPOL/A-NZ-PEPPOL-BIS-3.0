...
<xsl:stylesheet xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
  ...
  xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:u="utils"
  ...
  <xsl:function as="xs:boolean" name="u:gln">
    ...
    <xsl:variable name="digits"
      select="
        reverse(for $i in string-to-codepoints(substring($val, 0, $length + 1))
        return
          $i - 48)"/>
    <xsl:variable name="weightedSum"
      select="
        sum(for $i in (0 to $length - 1)
        return
          $digits[$i + 1] * (1 + ((($i + 1) mod 2) * 2)))"/>
    <xsl:value-of select="10 - ($weightedSum mod 10) = number(substring($val, $length + 1, 1))"/>
  </xsl:function>
  <xsl:function as="xs:boolean" name="u:abn">
    <xsl:param name="val"/>
    <xsl:value-of
      select="(((string-to-codepoints(substring($val, 1, 1)) - 49) * 10) + ((string-to-codepoints(substring($val, 2, 1)) - 48) * 1) + ((string-to-codepoints(substring($val, 3, 1)) - 48) * 3) + ((string-to-codepoints(substring($val, 4, 1)) - 48) * 5) + ((string-to-codepoints(substring($val, 5, 1)) - 48) * 7) + ((string-to-codepoints(substring($val, 6, 1)) - 48) * 9) + ((string-to-codepoints(substring($val, 7, 1)) - 48) * 11) + ((string-to-codepoints(substring($val, 8, 1)) - 48) * 13) + ((string-to-codepoints(substring($val, 9, 1)) - 48) * 15) + ((string-to-codepoints(substring($val, 10, 1)) - 48) * 17) + ((string-to-codepoints(substring($val, 11, 1)) - 48) * 19)) mod 89 = 0"
    />
  </xsl:function>
  ...
  <!--SCHEMA SETUP-->
  <xsl:template match="/">
    <svrl:schematron-output schemaVersion="iso"
  ...
  <!--RULE -->
  <xsl:template match="cbc:*" mode="M15" priority="1001">
  ...
  <!--RULE -->
  <xsl:template match="cac:*" mode="M15" priority="1000">
  ...
  <!--RULE -->
  <xsl:template match="ubl-creditnote:CreditNote | ubl-invoice:Invoice" mode="M16" priority="1013">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="$profile != 'Unknown'">
          ...
          <svrl:text>Business process MUST be in the format
            'urn:fdc:peppol.eu:2017:poacc:billing:NN:1.0' where NN indicates the process
            number.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert
          ...
          <svrl:text>Specification identifier MUST have the value
            'urn:cen.eu:en16931:2017#conformant#urn:fdc:peppol.eu:2017:poacc:billing:international:aunz:3.0’'.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert
          ...
          <svrl:text>Invoice total tax amount and Invoice total tax amount in accounting currency
            MUST have the same operational sign</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
  ...
  <!--RULE -->
  <xsl:template match="cbc:TaxCurrencyCode" mode="M16" priority="1012">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert
          ...
          <svrl:text>Tax accounting currency code MUST be different from invoice currency code when
            provided.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
  ...
  <!--RULE -->
  <xsl:template match="cac:AccountingCustomerParty/cac:Party" mode="M16" priority="1011">
  ...
  <!--RULE -->
  <xsl:template match="cac:AccountingSupplierParty/cac:Party" mode="M16" priority="1010">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="false()">
          ...
          <svrl:text>Allowance/charge base amount MUST be provided when allowance/charge percentage
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="false()">
          ...
          <svrl:text>Allowance/charge percentage MUST be provided when allowance/charge base amount
            is provided.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
  ...
  <!--RULE -->
  <xsl:template
    match="ubl-invoice:Invoice/cac:AllowanceCharge | ubl-invoice:Invoice/cac:InvoiceLine/cac:AllowanceCharge | ubl-creditnote:CreditNote/cac:AllowanceCharge | ubl-creditnote:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge"
    mode="M16" priority="1007">
    <svrl:fired-rule
  ...
  <!--RULE -->
  <xsl:template
    match="cbc:Amount | cbc:BaseAmount | cbc:PriceAmount | cac:TaxTotal[cac:TaxSubtotal]/cbc:TaxAmount | cbc:TaxableAmount | cbc:LineExtensionAmount | cbc:TaxExclusiveAmount | cbc:TaxInclusiveAmount | cbc:AllowanceTotalAmount | cbc:ChargeTotalAmount | cbc:PrepaidAmount | cbc:PayableRoundingAmount | cbc:PayableAmount"
    mode="M16" priority="1006">
    <svrl:fired-rule
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@currencyID = $documentCurrencyCode">
          ...
          <svrl:text>All currencyID attributes must have the same value as the invoice currency code
            (BT-5), except for the invoice total tax amount in accounting currency
            (BT-111).</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
  ...
  <!--RULE -->
  <xsl:template
    match="ubl-invoice:Invoice[cac:InvoicePeriod/cbc:StartDate]/cac:InvoiceLine/cac:InvoicePeriod/cbc:StartDate | ubl-creditnote:CreditNote[cac:InvoicePeriod/cbc:StartDate]/cac:CreditNoteLine/cac:InvoicePeriod/cbc:StartDate"
    mode="M16" priority="1005">
    <svrl:fired-rule
  ...
  <!--RULE -->
  <xsl:template
    match="ubl-invoice:Invoice[cac:InvoicePeriod/cbc:EndDate]/cac:InvoiceLine/cac:InvoicePeriod/cbc:EndDate | ubl-creditnote:CreditNote[cac:InvoicePeriod/cbc:EndDate]/cac:CreditNoteLine/cac:InvoicePeriod/cbc:EndDate"
    mode="M16" priority="1004">
    <svrl:fired-rule
  ...
  <!--RULE -->
  <xsl:template match="cac:InvoiceLine | cac:CreditNoteLine" mode="M16" priority="1003">
  ...
  <!--RULE -->
  <xsl:template match="cac:Price/cac:AllowanceCharge" mode="M16" priority="1002">
  ...
  <!--RULE -->
  <xsl:template match="cac:Price/cbc:BaseQuantity[@unitCode]" mode="M16" priority="1001">
  ...
  <!--RULE -->
  <xsl:template match="cac:AccountingSupplierParty/cac:Party[$supplierCountry = 'AU']" mode="M17"
    priority="1002">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert
          ...
          <svrl:text>[AUNZ-R-001]-An invoice must contain the Seller’s ABN if Seller country is
            Australia</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
  ...
  <!--RULE -->
  <xsl:template match="cac:AccountingCustomerParty/cac:Party[$buyerCountry = 'AU']" mode="M17"
    priority="1001">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert
          ...
          <svrl:text>[AUNZ-R-004]-An invoice must contain the Buyer’s ABN if Buyer country is
            Australia</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
  ...
  <!--RULE -->
  <xsl:template
    match="cbc:EndpointID[@schemeID = '0151'] | cac:PartyIdentification/cbc:ID[@schemeID = '0151'] | cbc:CompanyID[@schemeID = '0151']"
    mode="M17" priority="1000">
    <svrl:fired-rule
  ...
  <!--RULE -->
  <xsl:template match="cac:AccountingSupplierParty/cac:Party[$supplierCountry = 'NZ']" mode="M18"
    priority="1001">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert
          ...
          <svrl:text>[AUNZ-R-002]-An invoice must contain the Seller’s NZBN if Seller country is New
            Zealand</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(string-length(cac:PartyTaxScheme/cbc:CompanyID)>=1)">
          <xsl:attribute name="id">AUNZ-R-003</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="."/>
          </xsl:attribute>
          <svrl:text>[AUNZ-R-003]-A New Zealand invoice must contain the GST Number of the
            Seller</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
  ...
  <!--RULE -->
  <xsl:template match="cac:AccountingCustomerParty/cac:Party[$buyerCountry = 'NZ']" mode="M18"
    priority="1000">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert
          ...
          <svrl:text>[AUNZ-R-005]-An invoice must contain the Buyer’s NZBN if Buyer country is New
            Zealand</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
  ...
  <!--RULE -->
  <xsl:template match="cbc:EmbeddedDocumentBinaryObject[@mimeCode]" mode="M19" priority="1009">
  ...
  <!--RULE -->
  <xsl:template
    match="cac:Country/cbc:IdentificationCode | cac:OriginCountry/cbc:IdentificationCode" mode="M19"
    priority="1006">
    <svrl:fired-rule
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="some $code in $UNCL2005 satisfies normalize-space(text()) = $code">
          ...
          <svrl:text>Invoice period description code must be according to UNCL 2005
            D.16B.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
  ...
  <!--RULE -->
  <xsl:template
    match="cbc:Amount | cbc:BaseAmount | cbc:PriceAmount | cbc:TaxAmount | cbc:TaxableAmount | cbc:LineExtensionAmount | cbc:TaxExclusiveAmount | cbc:TaxInclusiveAmount | cbc:AllowanceTotalAmount | cbc:ChargeTotalAmount | cbc:PrepaidAmount | cbc:PayableRoundingAmount | cbc:PayableAmount"
    mode="M19" priority="1004">
    <svrl:fired-rule
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="some $code in $eaid satisfies @schemeID = $code">
          ...
          <svrl:text>Electronic address identifier scheme must be from the codelist "Electronic
            Address Identifier Scheme"</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M19" select="*"/>
